function processEMG(participant)
%PROCESSEMG Input participant (ex. "B01"), perform data
%filtering/processing and output file saving.
...
path='C:\Users\Brian\Desktop\Jose Workspace\participant data';
